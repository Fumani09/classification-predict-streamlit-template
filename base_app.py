...
def main():
	...
	options = ["lr Prediction","Random Prediction","SVM Prediction","Naives Prediction", "Information"]
...
#Random Forest
	# Building out the predication page
	if selection == "Random Prediction":
		st.info("Prediction with ML Models")
		# Creating a text box for user input
		tweet_text = st.text_area("Enter Text","Type Here")
...
#Naives 
	# Building out the predication page
	if selection == "Naives Prediction":
		st.info("Prediction with ML Models")
		# Creating a text box for user input
		tweet_text = st.text_area("Enter Text","Type Here")
